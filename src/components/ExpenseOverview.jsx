...
const ExpenseOverview = ({ transactions, setOpenAddExpenseModal }) => {
    return (
        <div className="rounded-xl shadow-lg bg-white py-4 p-2 md:px-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="md:text-sm text-xs text-gray-400">Track your earnings over time and analyze your expense trends.</p>
                </div>
                <button
                    onClick={() => setOpenAddExpenseModal(true)}
                    className="px-4 py-2 rounded cursor-pointer bg-purple-200 flex items-center gap-1">
                    <Plus size={15} />
                    <span className="md:text-sm text-xs">Add Expense</span>
                </button>
            </div>
            <div className="mt-10">
